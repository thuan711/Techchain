...
@section('title') Phân vai trò @endsection
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{url('admin/insert_roles',[$user->id_user])}}" method="POST">
                        @csrf
                        <p class="ml-2">Quyền</p>
                        ...
                        @foreach($permission as $key => $per)
                            <div class="form-check form-check-inline ml-2">
                                <input class="form-check-input" type="checkbox" id="{{$per->id}}" value="">
