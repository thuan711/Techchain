			...
			<div class="row">
						        ...
						        <div class="billing-address-form">
						        	<form action=""  method="post">
										...
										<label for="">Hình thức thanh toán</label>
											...
											<p><input style="display:none" name="ten_sp" readonly value="{{$ten_sp}}"></p>
											<p><input style="display:none" name="soluong" readonly value="{{$soluong}}"></p>
											<p><input style="display:none" name="gia" readonly value="{{$gia}}"></p>
											@if ($errors->any())
									...
									<tbody>
										@php 
											...
											echo "<tr class='table-body-row'>
												...
												<td> {$gia}<sup>&#273;</sup> </td>
												<td class='product-quantity p-2'><input value='{$soluong}' class='form-control text-center w-75 ml-2' disabled></td>
				...
				<div class="col-lg-4">
					<div class="order-details-wrap">
						...
						@csrf
							<p><input style="display:none" name="tongtien" readonly value="{{$tongtien}}"></p>
							<button type="submit" class="btn btn-warning mt-5 btn-default" name="redirect">Thanh toán VNPay</button>
						</form>
						<form action="{{url('/momo_payment')}}" method="POST">
							@csrf
							@if(isset($jsonResult['payUrl']))
        <input type="hidden" name="payUrl" value="{{ $jsonResult['payUrl'] }}">
    @endif
								<p><input style="display:none" name="tongtien" readonly value="{{$tongtien}}"></p>
								<button type="submit" class="btn btn-warning mt-5 btn-default" name="payUrl">Thanh toán Momo</button>
						</form>
					</div>
				</div>
			</div>
