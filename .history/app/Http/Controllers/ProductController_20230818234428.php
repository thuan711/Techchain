...
class ProductController extends Controller
{
    ...
    {
        $this->middleware('permission:publish product|edit product,add product,detele product',['only'=>['index','show']]);
        $this->middleware('permission:add product',['only'=>['create','store']]);
        $this->middleware('permission:edit product',['only'=>['edit','update']]);
        $this->middleware('permission:detele product',['only'=>['destroy']]);
    }
