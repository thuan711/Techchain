...
class SanphamController extends Controller
{
    ...
    public function vnpay_function(){
        ...
        $vnp_TxnRef = $_POST['12345']; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
        $vnp_OrderInfo = $_POST['Thanh toán đơn hàng'];
