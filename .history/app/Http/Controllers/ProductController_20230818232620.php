...
class ProductController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:publish articles|edit articles',['only'=>['create','store']]);
        $this->middleware('permission:publish articles|edit articles',['only'=>['edit','update']]);
        $this->middleware('permission:'detele product',['only'=>['detroy']]);
    }
