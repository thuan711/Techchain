...
class SanphamController extends Controller
{
    ...
    public function sortp($order, Request $request)
    {
        $perpage = 12;
        $products = Sanpham::orderBy('gia', $order)->paginate($perpage)->withQueryString();
        $loai = DB::table('loai')->get();
        return view('spsortp', ['products' => $products,'loai' => $loai]);
    }
