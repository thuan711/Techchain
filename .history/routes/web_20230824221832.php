...
Route::get('/thanhtoan', [SanPhamController::class,'thanhtoan'])->middleware('auth');
Route::post('/thanhtoan', [SanPhamController::class,'thanhtoan_'])->middleware('auth');
...
// Route::group(['prefix' => 'admin' ,'middleware' => ['adminauth', 'role: admin|writer'] ], function() {
Route::group(['prefix' => 'admin' ,'middleware' => ['adminauth'] ], function() {
    ...
    Route::post('/insert_roles/{id}',[UserController::class,'insert_role']);
...
Route::post('/export-csv', [SanPhamController::class,'export_scv'])->name('export_scv');
Route::post('/import-csv', 'SanPhamController@import_csv');
...
// cổng thanh toán
Route::post('/vnpay_payment',[SanPhamController::class,'vnpay_payment'])->name('vnpay_payment');
Route::post('/momo_payment',[SanPhamController::class,'momo_payment'])->name('momo_payment');
Route::get('/print-order/{id_sp}',[SanphamController::class,'print_order']);
Route::get('/a',[ThanhvienController::class,'index']);
Route::get('/sort/{order}', [SanphamController::class, 'sort'])->name('sort');
Route::get('/sortp/{orderp}', [SanphamController::class, 'sortp'])->name('sortp');
