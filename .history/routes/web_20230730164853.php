...
Route::get("/lienhe", function(Illuminate\Http\Request $request){ 
    $tb = $request->session()->get('thongbao');
    return view('lienhe',['thongbao'=> $tb]); 
});
//User
...
Route::get('/thanhtoan', [SanPhamController::class,'thanhtoan'])->middleware('auth','verified');
