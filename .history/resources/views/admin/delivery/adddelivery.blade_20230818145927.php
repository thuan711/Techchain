...
<div class="breadcrumb-sectiona breadcrumb-bg1">
    ...
    <div class="single-product pt-5 mb-150">
		<div class="container">
            <form class="mx-auto p-3" method="post" action="/delivery">
                ...
                <div class="mb-3">
                    <button type="submit" name="add_delivery" class="btn btn-warning py-2 px-5 add_delivery">Lưu</button>
                </div>  @csrf 
                @if ($errors->any())
