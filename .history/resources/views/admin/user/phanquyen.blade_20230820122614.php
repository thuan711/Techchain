            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{url('admin/insert_permission',[$user->id_user])}}" method="POST">
                        ...
                        <form class="mx-auto p-3" method="post" action="{{url('admin/insert_permission')}}">
                            @csrf
                            <div class="m-2">
                                <label>Tên quyền</label> 
                                <input class="form-control" type="text" placeholder="Tên quyền ...." name="permission" value="{{old('permission')}}">
                            </div>
                            <input type="submit" name="insertroles" value="Thêm quyền" class="btn p-2 mt-3 btn-success">
                        </form> 
