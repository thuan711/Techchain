    ...
    <div class="single-product pt-5 mb-150">
		<div class="container">
            <table class='table table-hover table-strip table-bordered'>
                ...
                <th>ID Đơn hàng</th> <th>Thời gian</th> <th>Thời điểm mua</th> <th>Tên người nhận</th><th>Số điện thoại & Địa chỉ</th><th>Trạng thái</th><th>Tổng tiền</th><th class="text-end">Hành động</th>
                </tr>
                @foreach ($dh as $dh)
