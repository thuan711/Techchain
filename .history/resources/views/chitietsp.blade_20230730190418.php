				...
				<div class="col-md-7">
					<div class="single-product-content">
						...
						<div class="single-product-form">
							...
							<input type="number" placeholder="1" id="quantity{{ $sp->id_sp }}" min="1" value="1">

							<a href="/themvaogio/{{$sp->id_sp}}/1" class="cart-btn" onclick="addToCart(event, {{ $sp->id_sp }})"><i class="fas fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
...
<script>
    function addToCart(event, productId) {
        ...
        // Cập nhật số lượng vào địa chỉ của liên kết
        var addToCartLink = '/themvaogio/' + productId + '/' + quantity;
