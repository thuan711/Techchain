						      ...
						      <div class="card-body">
						        <div class="billing-address-form">
						        	<form action="/admin/donhang"  method="post">
						        		<p><label for="">Họ tên (*)</label><input type="text" name="tennguoinhan"></p>
						        		<p><label for="">Email (*)</label><input type="email" name="email"></p>
						        		<p><label for="">Địa chỉ nhận hàng (*)</label><input type="text" name="diachigiaohang"></p>
						        		<p><label for="">Số điện thoai (*)</label><input type="tel" name="dienthoai"></p>
