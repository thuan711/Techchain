			...
			<div class="p-2">
				...
				<div class="row">
					<div class="col-sm-4 border-right border-solid-black ">
						<button type="button" class="btn btn-warning d-flex justify-content-center align-items-center float-center w-50 h-50 mx-2 mb-2" data-toggle="modal" data-target="#exampleModal">
