							...
							<ul>
								...
								<li>
									@guest
										<a href="#">Thành viên</a>
									@else
										<a href="#">{{ Auth::user()->ten}} {{Auth::user()->ho }}</a>
									@endguest
									<ul class="sub-menu">
										@guest
								...
								<li>
									<div class="header-icons">
										<a class="shopping-cart" href="/hiengiohang"><i class="fas fa-shopping-cart"></i></a>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="footer-box about-widget">
						<h2 class="widget-title">Về tôi</h2>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							<li>Gò Vấp, TP Hồ Chí Minh.</li>
							<li>hothuan6677@gmail.com</li>
							<li>0335 923 884</li>
						</ul>
					</div>
				</div>
