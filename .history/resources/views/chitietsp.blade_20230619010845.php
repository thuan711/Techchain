...
<div class="breadcrumb-section breadcrumb-bg">
	...
	<div class="single-product mb-5">
		<div class="container border border-solid-black border-radius-rounded">
			<div class="p-2">
				<h4>Đánh giá và nhận xét về {{$sp->ten_sp}}</h4>
				<div class="row">
					<div class="col-sm-6 border-right border-solid-black">
						<button class="btn btn-primary">Gửi đánh giá</button>
					</div>
					<div class="col-sm-6">
						<div class="detail-1 pb-0 p-2 d-inline-block">
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<p class="border border-solid-red w-100 h-max d-inline bg-success"></p>
							<p class="d-inline ml-3">0 đánh giá</p>
						</div> <br>
						<div class="detail-1 pt-0 p-2">
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
							<i class="fa fa-star" style="color: red"></i>
