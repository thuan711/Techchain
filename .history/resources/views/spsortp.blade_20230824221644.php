                        ...
                        <div class="input-group mb-3" id="timkiem">
                            ...
                            <div class="dropdown text-right" style="margin-left:500px">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{ route('sortp', ['order' => 'asc']) }}">Tăng dần</a>
                                  <a class="dropdown-item" href="{{ route('sortp', ['order' => 'desc']) }}">Giảm dần</a>
                                </div>
                            </div>						  
                        </div>
						...
						<div class="row">
							<div class="col-lg-12 text-center">
								<div class="pagination-wrap">
									<ul>
										<li><a href="#">Prev</a></li>
										<li>{{ $products->onEachSide(2)->links()}}</li>
										<li><a href="#">Next</a></li>
									</ul>
								</div>
							</div>
