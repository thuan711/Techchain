	...
	<div class="more-products mb-150">
		<div class="container">
			...
			<div class="row" id="splienquan">
				<div class="col-lg-4 col-md-6 text-center" id="data">
					<div class="single-product-item" class="sp">
                    @foreach($splienquan as $sp)
						<div class="">
							<a href="/sp/{{$sp->id_sp}}"><img src="{{$sp->hinh}}" alt="" width="150px" height="150px"></a>
						</div>
						<h3>{{$sp->ten_sp}}</h3>
