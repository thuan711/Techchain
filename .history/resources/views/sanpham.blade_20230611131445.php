				...
				<article class="col-sm-9" ng-controller="tnctrl">
					...
					<div class="input-group mb-3" id="timkiem">
						<form action="" method="get">
							<input type="submit" id="searchInput" onkeyup="searchTable()" class="form-control text-center" placeholder="🔍 Search" aria-describedby="basic-addon1">
						</form>
					</div>
						...
						<div class="card-body p-0">
							<ul class="list-group">
								<li class="list-group-item">
									<a href="/loai/{{$lo->id_loai}}">{{$lo->ten_loai}}</a>
								</li>
							</ul>
						</div>
						@endforeach
